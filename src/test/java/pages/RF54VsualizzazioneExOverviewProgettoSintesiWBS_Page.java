...
public class RF54VsualizzazioneExOverviewProgettoSintesiWBS_Page {
    public RF54VsualizzazioneExOverviewProgettoSintesiWBS_Page(){
    ...
    public WebElement consistenza;

   @FindBy(xpath = "/html/body/app-root/main/conf-fisica-cantiere/div/div[2]/div/div[2]/button/span")
    public WebElement clickOcchio;
}
