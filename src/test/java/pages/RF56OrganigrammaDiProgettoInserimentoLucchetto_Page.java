...
public class RF56OrganigrammaDiProgettoInserimentoLucchetto_Page {
   public RF56OrganigrammaDiProgettoInserimentoLucchetto_Page(){
    ...
    @FindBy(xpath = "/html/body/app-root/main/app-dashboard/div[3]/div[1]/div/div/div/div[3]/div/button[2]")
   public WebElement OrganigrammaDiProgetto;
}
