...
public class RF56OrganigrammaCantiereInserimentoLucchetto_2_stepCreazione_Page {
    public RF56OrganigrammaCantiereInserimentoLucchetto_2_stepCreazione_Page(){
    ...
    @FindBy(xpath = "//*[@id=\"cdk-step-label-0-1\"]/div[3]/div")
    public WebElement ruoli;
}
