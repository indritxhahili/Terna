...
public class RF56OrganigrammaCantiereInserimentoLucchetto_3_stepCreazione_Page {
  public   RF56OrganigrammaCantiereInserimentoLucchetto_3_stepCreazione_Page(){
    ...
    @FindBy(xpath = "//mat-step-header[@id='cdk-step-label-0-2']")
